...
.lesson-header-cell.clickable {
  cursor: pointer;
  transition: background-color 0.2s;
}

.lesson-header-cell.clickable:hover {
...
.summary-stats-cell .stats-grid {
  background: #e8f5e8;
}

.summary-stats-cell .stat-value {
  background: #e8f5e8;
  color: #2E7D32;
  font-weight: 700;
}
